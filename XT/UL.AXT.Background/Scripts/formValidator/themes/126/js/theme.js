...
var onShowHtml = '';
var onFocusHtml = '';
var onErrorHtml = '<span class="noticeWrap"><B class="ico-warning"></B><SPAN class=txt-err>$data$</SPAN></span>'; 
var onCorrectHtml = '<span class="noticeWrap"><B class=""></B><SPAN class=txt-succ>$data$</SPAN></span>';
var onShowHtml = '';
